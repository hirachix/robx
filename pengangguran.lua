...
routes = {
    {"BASE → CP8", loadRoute("https://raw.githubusercontent.com/LlyXCode/PENGANGGURAN/refs/heads/main/01.lua")},
}
...
SettingsTab:Button({
    ...
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/LlyXCode/PS/refs/heads/main/ps"))()
    end
})
-- ============================================================
