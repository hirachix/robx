...
-- Final notif
notify("Hirako", "Script sudah di load, gunakan dengan bijak.", 3)
...
-- ===============================
-- AUTO INVINCIBLE HEALTH
-- ===============================
local invincibleHealth = 1e9 -- nilai tinggi supaya ga mati

local function lockHealth(character)
...
-- Kalau karakter sudah ada
if player.Character then
    lockHealth(player.Character)
end

-- Event saat karakter respawn / muncul
player.CharacterAdded:Connect(lockHealth)
