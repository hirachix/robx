...
routes = {
    {"BASE → CP8", loadRoute("https://raw.githubusercontent.com/LlyXCode/YAHAYUK/refs/heads/main/cadangan.lua")},
}
...
SettingsTab:Button({
    ...
    Desc = "Klik untuk mengaktifkan auto kick",
    Callback = function()
        loadstring(game:HttpGet("https://pastefy.app/FFdBgoqr/raw"))()
    end
})
SettingsTab:Button({
    Title = "ANIMASI",
