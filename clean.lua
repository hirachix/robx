-- ======================================
-- Hirakoxs | MOUNT YAHAYUK (Renamed variables, fully formatted)
-- Semua variabel diganti menjadi nama deskriptif agar mudah dibaca & dimodifikasi
-- ======================================
...
-- XOR decode helper (originally v7)
...
local UILibrary = loadstring(game:HttpGet(
    "https://raw.githubusercontent.com/RullzsyHUB/roblox-scripts/refs/heads/main/UI%20Liblary/Rayfield.lua"
))()
...
-- ensure file exists locally; if not, download and create
